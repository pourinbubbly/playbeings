      ...
      <div className="relative -mx-6 px-6">
        <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-custom">
          {sortedGames.map((game) => (
            <div
              key={game._id}
              className="glass-card rounded-sm border-2 border-[var(--neon-purple)]/20 overflow-hidden hover-glow-purple transition-all group min-w-[180px] flex-shrink-0"
            >
              <div className="aspect-[2/3] bg-black/40 relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 space-y-2">
                  <h3 className="font-bold line-clamp-2 text-sm uppercase tracking-wide">
                    {game.name}
                  </h3>
                  <div className="flex items-center gap-1.5 text-xs text-[var(--neon-cyan)] font-semibold">
